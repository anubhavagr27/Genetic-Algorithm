function [parent] = zeroMutate(parent,bounds,Ops)
...
mPoint = round(rand * (numVar-1)) + 1;  % Pick a variable to mutate randomly from 1-number of vars
parent(mPoint) = 0; 		        % Make the child
